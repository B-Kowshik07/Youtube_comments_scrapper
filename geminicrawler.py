...
def scrape_youtube_comments(url):
    ...
    try:
        ...
        username_elems = driver.find_elements(By.XPATH, '//*[@id="author-text"]')[:5]
        comment_elems = driver.find_elements(By.XPATH, '//*[@id="content-text"]')[:5]
...
Return only "Good" or "Bad" as your response."""
    ...
    try:
        ...
        print(f"Gemini API response for comment: {comment}\nRaw response: {response.text}")
